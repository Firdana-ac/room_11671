...
public class WelcomeBackActivity extends AppCompatActivity {
    ...
    private static final String DUMMY_USERNAME = "firdana";
    ...
    // Shared Preferences yang akan digunakan untuk menulis dan membaca data
    ...
    private void autoLogin()
    {
        ...
        Boolean savedLogin =
                this.sharedPrefs.getBoolean(KEEP_LOGIN_KEY,false);
        if(savedLogin == true)
        {
